...
// use futures_util::stream::StreamExt; // TODO: Re-enable when fixing stream iteration
...
pub async fn launch_irc_client() -> Result<(), Box<dyn std::error::Error>> {
    ...
    tokio::spawn(async move {
        // TODO: Fix stream iteration - need to properly handle incoming messages
        /*
            ...
            _ = ui_refresh_interval.tick() => {
                terminal.draw(|f| {
                    let chunks = Layout::default()
                        ...
                        .split(ratatui::layout::Rect::default()); // TODO: Fix frame area access
